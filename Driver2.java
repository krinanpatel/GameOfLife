...
public class Driver2 {
    ...
    public static void displayPage(Page page) {
        ...
        for (Button option : OPTIONS) {
            option.changeColor(StdDraw.BOOK_LIGHT_BLUE);
        }
        ...
        switch(page) {
            case CONSTRUCTOR:
                ...
                for (int i = 0; i < constructors.length; i++) {
                    constructors[i].changeColor(StdDraw.BOOK_LIGHT_BLUE);
                }
            ...
            case INPUT:
                ...
                inputExtension.draw();
                inputSubmit.changeColor(StdDraw.BOOK_LIGHT_BLUE);
            ...
            case CREATE:
                ...
                for (Button btn : createBtns) {
                    btn.changeColor(StdDraw.BOOK_LIGHT_BLUE);
                }
                createBoard.draw();
            ...
            case METHOD:
                for (int i = 0; i < methods.length; i++) {
                    methods[i].changeColor(StdDraw.BOOK_LIGHT_BLUE);
                }
                ...
                if (nGen) {
                    ...
                    stepsText.draw();
                    methodSubmit.changeColor(StdDraw.BOOK_LIGHT_BLUE);
                }
                ...
                case "Cell State":
                    {
                        ...
                        displayPage(Page.METHOD);
                        activeBoard.changeColor(StdDraw.BOOK_LIGHT_BLUE);
                        StdDraw.show();
                        ...
                        displayPage(Page.METHOD);
                        activeBoard.fillCell(coords[1], coords[0], StdDraw.BOOK_LIGHT_BLUE);
                        StdDraw.show();
                    }
                    break;
